...
| 2023-01-03 | 55400.0 | 56000.0 | 54500.0 | 55400.0 | 13547030 |
| 2023-01-04 | 57800.0 | 58000.0 | 55600.0 | 55700.0 | 20188071 |
| 2023-01-05 | 58200.0 | 58800.0 | 57600.0 | 58200.0 | 15682826 |
| 2023-01-06 | 59000.0 | 59400.0 | 57900.0 | 58300.0 | 17334989 |
...
- **이상치(Outlier)**: 통상적으로 Z-score 3 이상 또는 IQR 1.5 범위를 벗어나는 급등락을 이상치로 간주합니다. 2023~2024년 삼성전자 데이터에서는 일일 변동폭(수익률) 기준 절대값 10%를 초과하는 비정상적인 틱 데이터가 검출되지 않았으므로 원본을 유지했습니다.
...
> **요약**: 2023년 우상향 트렌드 이후 2024년 말 120일선을 하향 이탈하며 추세가 꺾임. (최고가: 약 8.4만, 최저가: 약 4.8만)
...
> **요약**: 변동성을 계산하는 윈도우 크기(10, 20, 40일)에 따른 민감도를 테스트함. 10일 선(Cyan)은 단기 이벤트에 민감하게 반응하여 노이즈가 크고, 40일 선(Magenta)은 반응이 지연됨. **20일 선(Purple)이 추세적 변동성을 파악하는 데 가장 적합(Robust)함**. 특히 2024년 8월경 표준편차가 3000 이상 치솟을 때 최대 거래량이 동반됨.
...
1. **2023년 우상향과 2024년 추세 이탈 (장기 이평선 기준)**
   - **관찰(Fact)**: 2024년 상반기 최고가(8.4만) 달성 후, 3분기에 120일선을 -5% 이상 하향 이탈하며 하락 추세로 전환됨.
...
2. **변동성 극대화 및 거래량 동반 패닉 셀링**
   - **관찰(Fact)**: 변동성 그래프(3번)에서 2024년 8~9월경 20일 롤링 표준편차가 평시(1000 수준) 대비 **3배 이상 폭등(3000 이상)**하며 연간 최대 거래량이 발생함.
